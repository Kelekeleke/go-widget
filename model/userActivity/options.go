...
func OptionQueryMulti(days string) (res []interface{}) {
	...
	sql := "select version,device,country,param,udid,vcname from `" + table + "` where version != 90909 and vcname in ('widgetShow','widgetAdd','widgetClick','widgetCreate') and param like " + "'%" + "designName%' limit 1"
